...
internal class Program
{
    ...
    private static void LoadDataReisdocumenten(DbContextOptions<ReisdocumentenDbContext> options)
    {
        ...
        var reisdocumenten = new List<Reisdocument>
        {
            ...
            new Reisdocument { DocumentNr = 123456, Soort = soorten.ElementAt(0), Aanvraagdatum = new DateTime(2024, 03, 20, 12, 30, 00), Afgifteplaats = "Hamelen", Afgiftedatum = new DateTime(2024, 04, 25), Verloopdatum = new DateTime(2023, 07, 25), Status = "Actief", Opgehaald = true, Burger = burgers.ElementAt(0), Medewerker = medewerkers.ElementAt(0)},
